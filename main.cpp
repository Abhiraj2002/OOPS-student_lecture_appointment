...
using namespace std;
// to count each student,lec and appo. in the file
int count[3];

// base People class for students and lec
class People
{
private:
	// People properties which are same for Student and lec
	string number;
	string name;
	string surname;
	string department;
...
int main(int argc, char **argv)
{
	...
	Lecturer _L[100];
	Appointment _A[100];
	// read information of students, lecturers and appointments from the given files
